...
export default class ByteStream {
  constructor (byteArrayParser, byteArray, position) {
    ...
    if ((byteArray instanceof Uint8Array) === false &&
          (byteArray instanceof ArrayBuffer) === false) {
  ...
  setPosition(position) {
      if (position < 0) {
          throw 'byteStream.setPosition: cannot set position to < 0';
      } else if (position >= this.byteArray.length) {
          throw 'byteStream.setPosition: cannot set position greater than or equal to \'byteArray.length\'';
      }
  ...
  readUint8 () {
    var result = this.byteArray[this.position];
  ...
  readInt16 () {
    var result = this.byteArrayParser.readInt16(this.byteArray, this.position);
  ...
  readFloat () {
    var result = this.byteArrayParser.readFloat(this.byteArray, this.position);
  ...
  readDouble () {
    var result = this.byteArrayParser.readInt64(this.byteArray, this.position);
