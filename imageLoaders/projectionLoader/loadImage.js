...
export function loadCoaxialImage(imageId, slice_number) {
    return cornerstone.loadImage(imageId + '/' + coaxial + '/' + slice_number);
}

export function loadSagitalImage(imageId, slice_number) {
    return cornerstone.loadImage(imageId + '/' + sagital + '/' + slice_number);
}
